...
const words = ["design", "build", "automate", "captivate"];
    ...
    <section className="relative min-h-screen flex flex-col justify-start md:justify-center items-start bg-black overflow-x-hidden">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 pt-24 pb-6 md:py-24 lg:py-28">
        ...
        <div className="mb-0 md:mb-12">
          <h1 
            className={`text-left text-[clamp(1.75rem,6vw,5.5rem)] font-display leading-[0.95] tracking-tight text-white transition-all duration-1000 ${
      ...
      >
        <div className="flex flex-wrap items-start gap-x-10 gap-y-4 lg:gap-x-20">
          {[
            ...
            { value: "5★",   count: "5",   suffix: "★", label: "average client rating" },
          ].map((stat) => (
