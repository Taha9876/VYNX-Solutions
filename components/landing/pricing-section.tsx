...
const plans = [
  {
    name: "Starter",
    description: "For businesses ready to launch online",
    price: 75000,
    features: [
      "5-page website",
      "Mobile responsive",
  ...
  },
  {
    ...
    price: 175000,
    features: [
      "Animated website (up to 10 pages)",
  ...
  {
    name: "Enterprise",
    description: "For organisations that need more",
    price: null,
    features: [
...
export function PricingSection() {
  ...
  return (
    <section id="pricing" ref={sectionRef} className="relative py-16 md:py-32 lg:py-40">
                ...
                <div className="p-8 lg:p-10">
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-xs text-muted-foreground mt-2 font-mono">
                      {plan.price !== null ? "one-time project fee" : "contact us for pricing"}
                    </p>
                  </div>
