...
const steps = [
  {
    ...
    description: "We start with a deep-dive into your goals, audience, and competitors. You get a clear project roadmap before a single pixel is designed.",
    code: `// Discovery call — week 1
project.define({
  goals: ['leads', 'brand', 'revenue'],
  audience: 'B2B SaaS founders',
  competitors: ['acme.com', 'rival.io'],
  deliverables: 'roadmap + wireframes'
})`,
  },
  {
    number: "02",
    ...
    description: "Our designers craft pixel-perfect mockups and interactive prototypes. You review and approve every screen before we write a line of code.",
    code: `// Design phase — weeks 2–3
design.create({
  brand: { fonts, colors, motion },
  screens: ['home', 'services', 'contact'],
  interactions: 'scroll-triggered',
  approval: client.signOff()
})`,
  },
  {
    number: "03",
    title: "Deliver",
    subtitle: "on time",
    description: "We build, test, and launch your project on schedule. Post-launch support ensures everything runs perfectly from day one.",
    code: `// Launch — week 4
project.ship({
  tested: ['performance', 'mobile', 'seo'],
  lighthouse: { score: 98 },
  support: '30-day included',
  status: 'live 🚀'
})`,
  },
];
...
export function HowItWorksSection() {
  ...
  return (
    <section
      id="how-it-works"
      ref={sectionRef}
      className="relative py-14 md:py-24 lg:py-32 bg-[oklch(0.09_0.01_260)] text-white overflow-hidden"
    >
