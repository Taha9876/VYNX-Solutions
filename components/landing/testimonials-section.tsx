...
const testimonials = [
  {
    quote: "VYNX set up our AI receptionist in under a week. It handles every customer query, books meetings, and qualifies leads around the clock. We used to miss half our inquiries after 6pm — that doesn't happen anymore.",
    author: "Ahmad Tariq",
    role: "CEO",
    company: "A&T Solutions",
    url: "https://a-and-t-solutions.vercel.app/",
    metric: { value: "95%", label: "Queries automated" },
  },
  {
    quote: "They built our entire recruitment platform in three weeks — AI candidate matching, a full client dashboard, the works. Honestly the fastest and most professional team we've worked with.",
    author: "Sara Amir",
    role: "Co-Founder",
    company: "Hire Karo",
    url: "https://frontend-for-hire-karo.vercel.app/",
    metric: { value: "3 wks", label: "Brief to live platform" },
  },
  {
    quote: "We needed a high-impact animated landing page for our product launch and VYNX delivered something that genuinely looked world-class. Customers were sharing it on WhatsApp — it became marketing on its own.",
    author: "Usman Ghani",
    role: "Head of Marketing",
    company: "TechVision PK",
    url: "https://iphone-17-pro-landing-page-ibku.vercel.app/",
    metric: { value: "3x", label: "Engagement vs old page" },
  },
  {
    quote: "Our website was a basic template before. Now clients tell us the site is what made them reach out. The animations carry the same emotion as the films we make — that's hard to get right, and VYNX got it right.",
    author: "Jahanzaib Ahmed",
    role: "Founder",
    company: "Joji Studio",
    url: "https://jojistudio.vercel.app/",
    metric: { value: "2x", label: "Booking inquiries" },
  },
];
                ...
                <div>
                  ...
                  <p className="text-background/60">
                    ...
                    <a
                      ...
                      className="hover:text-background underline underline-offset-2 transition-colors"
                    >
